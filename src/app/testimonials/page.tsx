...
const testimonials = [
	{
		...
		relationship: "Mother",
		text: "Seeing my child excel in O-Levels while gaining practical vocational skills is a dream come true. Walugogo VHS didn't just teach academics—they shaped his character, instilled discipline, and prepared him for university. The holistic approach to secondary education is remarkable. My son is confident, well-rounded, and prepared for success.",
		rating: 5,
		achiievement: "Son excelling academically with O-Levels while gaining vocational certifications",
...
const featuredStory = {
	...
	impact: "Family now advocates for Walugogo VHS, encouraging many secondary learners to enroll"
};
